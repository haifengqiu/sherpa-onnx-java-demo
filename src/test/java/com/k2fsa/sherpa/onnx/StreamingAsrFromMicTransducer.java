...
public class StreamingAsrFromMicTransducer {
  public static void main(String[] args) {
    // please refer to
    // https://k2-fsa.github.io/sherpa/onnx/pretrained_models/online-transducer/zipformer-transducer-models.html#csukuangfj-sherpa-onnx/asr-bilingual-chinese-english
    ...
    String hotwordsFile =
      "./sherpa-onnx/asr/hotwords_mix.txt";
